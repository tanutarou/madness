...
namespace madness {
    ...
    void mTxmq(long dimi, long dimj, long dimk,
               cT* restrict c, const aT* a, const bT* b, const int a_pad, const int b_pad, const int c_pad) {
    ...
    template <>
    void mTxmq(long dimi, long dimj, long dimk,
               double* restrict c, const double* a, const double* b, const int a_pad, const int b_pad, const int c_pad);
    ...
    template <>
    void mTxmq(long dimi, long dimj, long dimk,
               double_complex* restrict c, const double_complex* a, const double* b, const int a_pad, const int b_pad, const int c_pad);
#endif
